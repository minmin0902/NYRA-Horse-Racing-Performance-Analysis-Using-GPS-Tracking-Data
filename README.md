...
```
.
├── Complete_EDA_and_Preprocessing.ipynb   # EDA + feature engineering pipeline
├── NYRA_Horse_Racing_Prediction.ipynb     # Modeling, evaluation, SHAP
├── MinJoo_Kim_Midterm_Presentation.pptx   # Project presentation
├── requirements.txt
├── LICENSE
├── README.md
│
...
> Place the Kaggle CSVs into `data/` before running. Outputs are generated by the notebooks.
